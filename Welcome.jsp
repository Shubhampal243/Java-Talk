...
<%
       ...
       %>
    <b style="color:red;font-size:2em"> <%= "Hello Ms/Mr."+uid+" Welcome to Java Forum"%> </b><br>
<A href = "http://localhost:8084/onlinetest/onlinetest1.jsp"> Attempt Java Test </A><br/>
<A href = "http://localhost:8084/onlinetest/joinforum.jsp"> Join Java Blog </A><br/>
