...
//session.putValue("Connect",Cn);
          ...
          if (rs.next()) {
          session.putValue("Log",uid); 

 // %>
   // <jsp:forward page="/Welcome.jsp" />  
 // <%
  
response.sendRedirect("http://localhost:8084/onlinetest/Welcome.jsp");
                       }
      else  {
...
<h1>Error Page</h1>
   ...
   <A href = "http://localhost:8084/onlinetest/Login4.html"> Login Again </A>
