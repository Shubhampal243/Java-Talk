...
//Connection con=Cn.getCon();
           ...
           PreparedStatement psm = con.prepareStatement("Select sq from reg where uid1=?");
           psm.setString(1, uid);
           ResultSet rs = psm.executeQuery();
       if (rs.next()) {
String sq=rs.getString("sq");
response.sendRedirect("http://localhost:8084/onlinetest/Forget1.jsp?x="+uid+"&y="+sq);
                       }
      else  {
       %>
    <b style='color:red;font-size:2em;'> <%= "Sorry"+uid+" is invalid....."%> </b><br>
   <A href = "http://localhost:8084/onlinetest/Forget.html">BACK</A>
<%
   }
