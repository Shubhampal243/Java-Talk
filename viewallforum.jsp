...
PreparedStatement psm = con.prepareStatement("select * from postq",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
...
<i> <%="Question posted :-"+post+"<a href=http://localhost:8084/onlinetest/replyq1.jsp?qid="+qid+">Reply this Question</a>" %></i><br/>
